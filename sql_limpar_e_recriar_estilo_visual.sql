-- ========================================
-- LIMPEZA COMPLETA E RECRIAÇÃO DO ESTILO VISUAL
-- Remove todos os dados antigos e insere os novos
-- ========================================
...
-- 2. LIMPAR TODOS OS DADOS DE ESTILO VISUAL EXISTENTES

-- Deletar cenas que têm valor_selecao que vamos usar (evita conflitos)
DELETE FROM cenas WHERE valor_selecao IN (
    'realismo', 'impressionismo', 'art_nouveau', 'surrealismo', 'cubismo', 'expressionismo', 'barroco', 'minimalismo',
    'cyberpunk', 'vaporwave', 'glitch_art', 'low_poly', 'pixel_art', 'synthwave', 'holografico', 'neon_noir',
    'film_noir', 'wes_anderson', 'tim_burton', 'blade_runner', 'studio_ghibli', 'matrix', 'mad_max', 'tron',
    'anime_classico', 'manga', 'chibi', 'concept_art', 'watercolor', 'comic_book', 'pixar', 'disney', 'pin_up', 'cartoon',
    'fotorealismo', 'vintage', 'polaroid', 'hdr', 'macro', 'tilt_shift', 'long_exposure', 'double_exposure',
    'fantasy_art', 'steampunk', 'fairy_tale', 'dark_fantasy', 'mythology', 'cosmic_horror', 'ethereal', 'crystal_art'
);

-- Deletar cenas de blocos que possam ter estilo_visual
DELETE FROM cenas WHERE bloco_id IN (
    SELECT id FROM blocos_cenas WHERE tipo_aba = 'estilo_visual' OR titulo IN (
        'Estilos Artísticos Clássicos', 'Estilos Digitais e Modernos', 'Estilos Cinematográficos',
        'Ilustração e Anime', 'Estilos Fotográficos', 'Fantasia e Magia'
    )
);

-- Deletar blocos de estilo_visual ou com títulos específicos
DELETE FROM blocos_cenas WHERE tipo_aba = 'estilo_visual' OR titulo IN (
    'Estilos Artísticos Clássicos', 'Estilos Digitais e Modernos', 'Estilos Cinematográficos',
    'Ilustração e Anime', 'Estilos Fotográficos', 'Fantasia e Magia'
);

-- 3. INSERIR BLOCOS NOVOS (6 blocos)

INSERT INTO blocos_cenas (titulo, icone, tipo_aba, ordem_exibicao, ativo) VALUES
('Estilos Artísticos Clássicos', 'palette', 'estilo_visual', 1, true),
('Estilos Digitais e Modernos', 'computer', 'estilo_visual', 2, true),
('Estilos Cinematográficos', 'movie', 'estilo_visual', 3, true),
('Ilustração e Anime', 'brush', 'estilo_visual', 4, true),
('Estilos Fotográficos', 'camera_alt', 'estilo_visual', 5, true),
('Fantasia e Magia', 'auto_fix_high', 'estilo_visual', 6, true);

-- 4. INSERIR TODAS AS 50 CENAS
...
-- ========================================
-- RESUMO FINAL:
-- - 6 blocos de estilo_visual criados
-- - 50 cenas únicas incluindo Pixar e Disney
